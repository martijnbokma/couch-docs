...
:::tip
You can use the Couch tags [**dump**](../../tags-reference/dump.html) and [**dump_all**](../../tags-reference/dump_all.html) to see for yourself all the variables with their current values.
:::
