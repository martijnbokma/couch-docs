...
keywords: [google maps, maps integration, geolocation, contact page]
category: concept
---
...
Couch abstracts away the complexity of creating a Google map behind a simple tag - the [__*google_map*__](../../tags-reference/google_map/) tag.
