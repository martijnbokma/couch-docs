---
title: Pretty URLs
description: Learn how to implement and configure search engine friendly URLs in CouchCMS
keywords: [pretty urls, SEF, SEO, mod_rewrite, htaccess, URL rewriting]
category: concept
sidebar:
    order: 23
...
**TIP:** You can also use Notepad to create a new file and when asked for a name while saving it, enclose the name with **double-quotes**.
:::
