...
The [__*excerptHTML*__](../../tags-reference/excerpthtml/) tag can be used to output only an excerpt of your page.
We need to wrap the output within [__*html_encode*__](../../tags-reference/html_encode/) to encode certain characters that are not valid in XML.
