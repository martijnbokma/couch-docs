...
1.  The [__*cms:form*__](../../tags-reference/form/) and [__*cms:input*__](../../tags-reference/input/) tags to implement the front-end form.
2.  A clonable template with [__*cms:editable*__](../../tags-reference/editable/) tags to hold data.
