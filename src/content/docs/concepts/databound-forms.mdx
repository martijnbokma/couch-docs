...
keywords: [databound forms, form, database, create, update, delete, user interface, web development, CMS templates]
sidebar:
    order: 29
...
1. The [**_cms:form_**](../../tags-reference/form/) and [**_cms:input_**](../../tags-reference/input/) tags to implement the front-end form.
2. A clonable template with [**_cms:editable_**](../../tags-reference/editable/) tags to hold data.
...
I am sure you'd be surprised to notice that the only change we've done is convert the 'type' of _all_ cms:input tags to 'bound'.
...
One such service is provided by [StopForumSpam](https://www.stopforumspam.com/). This site mantains a list of known spammers as identified by the emails, usernames and IP addresses they tend to use while spamming around the Internet.
...
Incorporating this spam-check in our form couldn't be any simpler. We have a new tag named 'check\*spam' to handle that.
