...
A template can be marked as being clonable by using the [**template**](../../tags-reference/template/) tag somewhere within it and setting its `clonable` parameter to `1`.
