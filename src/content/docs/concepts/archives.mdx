...
If you recall the [***pages***](../../tags-reference/pages.html) tag, pages belonging to a particular time period can be easily fetched by setting the `start_on` and `stop_before` parameters.
