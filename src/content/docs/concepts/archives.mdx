...
[__*Archives*__](../../tags-reference/archives/) tag is used to find out all the past time periods (years, months and days) during which atleast one page has been published.
...
The [__*date*__](../../tags-reference/date/) tag converts it into a displayable format.
:::
...
By pointing your browser to these urls, you'll be accessing your _blog.php_ template in _archive-view_ (see: [**Views**](../views/)).
...
It shouldn't be difficult to set up the [__*pages*__](../../tags-reference/pages/) tag to list pages belonging the archive period by using these variables (see: [**Listing Pages**](../listing-pages/)).
