...
In the snippet above, message will be set to 'Hello World' which was the output of the nested [**show**](../../tags-reference/show/) tag.
...
Couch would have used the value of a non-existent variable _Hello_ as parameter for [**show**](../../tags-reference/show/), which would then have printed nothing.
:::
...
The above snippet uses three new tags - [**if**](../../tags-reference/if/), [**exists**](../../tags-reference/exists/) and [**embed**](../../tags-reference/embed/).
...
Always begin from the innermost tag, which here happens to be the [**show**](../../tags-reference/show/) tag.
We are already familiar with the [**show**](../../tags-reference/show/) tag.
...
Assuming that the current page is _about-us_, substituting [**show**](../../tags-reference/show/) tag with its output will result in:
...
Resolve the contents of [**if**](../../tags-reference/if/), using our substitution method:
