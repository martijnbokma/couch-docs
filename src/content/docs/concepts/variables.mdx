...
For example - we have already seen how the [**repeat**](../../tags-reference/repeat/) tag simply repeats the contents enclosed within it the number of times specified by the _count_ parameter. At each iteration, the [**repeat**](../../tags-reference/repeat/) tag sets a variable named _k_count_ that is set to the count of the current iteration:
