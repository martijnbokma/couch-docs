...
keywords: [folder, tag, PHP, organization, hierarchy, structure, virtual]
---
...
Please see [**Core Concepts - Folders**](../../concepts/folders.html) for a detailed explanation of this tag.
