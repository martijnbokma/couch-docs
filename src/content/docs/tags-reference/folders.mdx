...
keywords: [folders, tag, PHP, enumeration, hierarchy, navigation, virtual]
---

The **folders** tag can be used to enumerate the virtual folders that have been defined for a template.

Please see [**Core Concepts - Folders**](../../concepts/folders.html) for an in-depth discussion of this tag.
