...
:::caution
Make sure that the type of the editable region is _textarea_ and that its *no_xss_check* parameter is set to '1' (this will prevent Couch from mangling up the < and > tags the way it usually does to stop XSS attacks).
:::
