...
keywords: [group, CouchCMS, Couch, tags, PHP, editable]
...
Of the four regions, three are closely related (_prop_image_, _prop_image_thumb_ and _prop_document_) since they need the user to upload something from his machine to the server.
