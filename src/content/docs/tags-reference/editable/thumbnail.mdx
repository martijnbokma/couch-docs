...
```php title="Basic Image Region Example"
...
```php title="Thumbnail Region Example"
<cms:editable
    name='my_image_thumb'
...
```php title="Width-Only Thumbnail Example"
...
```php title="Fixed Dimensions Example"
<cms:editable name='my_image_thumb' label='Image Thumbnail' desc='Thumbnail of main image'
    width='100'
    height='80'
    show_preview='1'
...
```php title="Quality Parameter Example"
<cms:editable name='my_image_thumb' label='Image Thumbnail' desc='Thumbnail of main image'
    width='100'
    show_preview='1'
    quality='50'
...
```php title="Preview Parameter Example"
<cms:editable name='my_image_thumb' label='Image Thumbnail' desc='Thumbnail of main image'
    width='100'
    show_preview='1'
    assoc_field='my_image'
...
```php title="Preview Size Example"
<cms:editable name='my_image_thumb' label='Image Thumbnail' desc='Thumbnail of main image'
    width='100'
    show_preview='1'
    preview_width='80'
