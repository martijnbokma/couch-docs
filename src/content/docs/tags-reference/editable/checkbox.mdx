...
Unlike its counterparts, [`dropdown`](../dropdown/) and [`radio`](../radio/) types, `checkbox` type can contain multiple selected options. In the example given above, if the user selected *Entertainment*, *Sports* and *Health*, the following code:
