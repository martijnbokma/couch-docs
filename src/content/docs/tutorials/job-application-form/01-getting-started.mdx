...
:::tip[Note]
Beginning with 1.4, new installations will find a file named `kfunctions.example.php` in the addon folder. This is to prevent future upgrades from overwriting your changes. Please rename this file to `kfunctions.php` and uncomment the mentioned line from it.
:::
...
1. The [***cms:form***](../../tags-reference/form.html) and [***cms:input***](../../tags-reference/input.html) tags to implement the front-end form.
2. A clonable template with [***cms:editable***](../../tags-reference/editable.html) tags to hold data.
...
![Databound Forms Example](../../../../assets/img/contents/databound-forms-1.png)
...
It should be trivial to 'couchify' the plain HTML form we have in our template (as explained [here](../../../concepts/forms.html)).
...
1. **Modify the `cms:form` tag**

    ```diff lang="php" title="applications.php"
    - <cms:form method='post' anchor='0'>
    + <cms:form
...
3. **Persist submitted values on successful form submission**
    ...
    ![Databound Forms Example](../../../../assets/img/contents/databound-forms-2.png)

    Try editing any such page and you should see all the data that was submitted.

    ![Databound Forms Example](../../../../assets/img/contents/databound-forms-3.png)
...
[Anti Spam Questions Your Spam Bot Cant Answer](https://www.reverbstudios.ie/2649/anti-spam-questions-your-spam-bot-cant-answer/)
...
One such service is provided by [stopforumspam.com](https://www.stopforumspam.com/). This site mantains a list of known spammers as identified by the emails, usernames and IP addresses they tend to use while spamming around the Internet.
...
![Databound Forms Example](../../../../assets/img/contents/databound-forms-4.png)
...
Visit the admin-panel and access the `application.php` template. Here is what should appear -

![Databound Forms Example](../../../../assets/img/contents/databound-forms-5.png)
...
![Databound Forms Example](../../../../assets/img/contents/databound-forms-6.png)
...
![Databound Forms Example](../../../../assets/img/contents/databound-forms-7.png)

Here is another example done on a different site:

![Databound Forms Example](../../../../assets/img/contents/databound-forms-8.png)
...
![Databound Forms Example](../../../../assets/img/contents/databound-forms-9.png)
...
![Databound Forms Example](../../../../assets/img/contents/databound-forms-10.png)
