...
description: Learn how to create a simple About Us page in CouchCMS by converting a static HTML template into a dynamic, editable page.
keywords: [about us, static template, editable regions, richtext editor, template conversion]
category: tutorial
...
[Download Couchified Code](https://www.couchcms.com/docs/code/about.zip)
</Card>
...
![Admin Panel Showing About.php Template](../../../../assets/img/contents/portfolio-site-11.jpg)
...
![Editable Regions in About Us Page](../../../../assets/img/contents/portfolio-site-12.png)

### Main Content Region

Find the HTML block representing the main content region and surround it with Couch's editable tags:
...
![Admin Panel with Editable Regions](../../../../assets/img/contents/portfolio-site-17.png)
...
Add the following line containing the template tag somewhere at the top of the page (below the boilerplate PHP include code):
...
![Template Listed as About Us](../../../../assets/img/contents/portfolio-site-19.png)
...
[Next Chapter: Diving Deep - The Blog (Part 1)](../blog/)
