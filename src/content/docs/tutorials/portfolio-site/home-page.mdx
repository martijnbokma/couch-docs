...
[Download the Couchified code](https://www.couchcms.com/docs/code/home.zip)
...
![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-179.png)

![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-180.png)
...
![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-181.png)
...
![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-182.png)
...
![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-183.png)
...
![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-184.png)
...
![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-185.png)
...
![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-186.png)
...
![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-187.png)
...
![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-188.png)

Finally, use the variables set by the enumerator tag belonging to each fetched object

![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-189.png)

Visit `http://www.mytestsite.com/` to see the results of your work -

![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-190.png)
...
[We'll tie all the loose ends in the next tutorial.](../tying-the-loose-ends/)
