...
![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-20.png)
...
![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-23.png)

Next we'll place the editable tags defining the two editable regions we identified above within this template tag -

![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-24.png)
...
![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-26.png)

and replace the text shown as content by a show tag -

![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-27.png)
...
![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-28.png)
...
![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-29.png)
...
![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-31.png)
...
![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-43.png)

and place the closing if tag `</cms:if>` after the HTML

![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-44.png)
...
![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-45.png)
...
![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-46.png)
...
![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-47.png)
...
![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-50.png)
...
![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-51.png)
...
![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-52.png)
...
![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-53.png)
...
![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-56.png)

and replace it with

![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-57.png)
...
![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-60.png)

with `k_comments_count` variable

![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-61.png)
...
As you know, Couch provides information about the page being accessed by setting up variables. `k_page_foldertitle` is the variable that contains the title of the folder a cloned page resides in (remains blank if the page does not reside in any folder) [see [Variables available in Views](../../../../concepts/variables-in-views/)].
...
![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-67.png)

Replace it with -

![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-68.png)
...
:::note
You might recall from the documentation that apart from the variables set up by Couch (the system variables that are all prefixed by a 'k\_'), we can define our own variables. [see [Variables](../../../../concepts/variables/)].
:::
...
![Portfolio Site Example](../../../../assets/img/contents/portfolio-site-71.png)
...
[Diving deep - the Blog (Part 2)](../blog-2/)
