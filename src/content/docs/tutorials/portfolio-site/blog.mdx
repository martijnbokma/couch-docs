...
keywords: [blog, template, cloning, editable regions, virtual folders, CouchCMS]
category: tutorial
...
and the following page should appear:
...
once again and you should see the contents of `blog_list.html` being displayed.
