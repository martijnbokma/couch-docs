...
Couch has a tag named [**pages**](../../../tags-reference/pages/) that is used to enumerate or list pages belonging to a particular template.
...
[Next Chapter: **The Portfolio Section**](../05-portfolio/)
