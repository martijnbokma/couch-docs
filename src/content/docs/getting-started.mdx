...
See [Building a Real World Site](http://docs.couchcms.com/tutorials/portfolio-site/building-a-real-world-site.html)
...
:::note
We'll assume the site's address to be `http://www.mytestsite.com/`. Replace it with your site's address for all examples.
:::
